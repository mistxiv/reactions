...
return true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "bec70bde-b9c0-dec2-8290-2cecdbaadf22";
	};
	[2] = {
		["actions"] = {
			[1] = {
...
function MU.gs_set(tbl)\
   if (MU.gs_set_last == nil) then\
      MU.gs_set_last = 0\
   end\
   if (TimeSince(MU.gs_set_last) < 5000) then\
      return\
   end\
...
return medicated_spiritbond";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "dbe607f5-d56a-093f-896f-57a2fcb51137";
	};
	[3] = {
		["actions"] = {
			[1] = {
...
return true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "4980b1d0-a637-7c8a-aa7c-a5c63f691d5b";
	};
	[4] = {
		["actions"] = {
			[1] = {
...
return false";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "73c53944-3e5d-5489-81d8-a9f9cbfc408c";
	};
	[5] = {
		["actions"] = {
			[1] = {
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "ae1fa5d8-8fb4-8cac-95c7-d4faf4922f34";
	};
	[6] = {
		["actions"] = {
			[1] = {
...
return false";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "9671216e-facd-87f7-8d60-5ea67070eb7b";
	};
	[7] = {
		["actions"] = {
			[1] = {
...
local items_summed = {\
   ...
   [25] = 0, -- wolf mark\
   [27] = 0, -- allied seal\
   [28] = 0, -- allagan poetics\
   [29] = 0, -- mgp\
   [42] = 0, -- allagan aphorism\
   [21072] = 0, -- venture\
   [25199] = 0, -- white crafters' scrip\
   [25200] = 0, -- white gatherers' scrip\
   [26807] = 0, -- bicolor gemstone\
   [28063] = 0, -- skybuilders' scrip\
   [33328] = 0, -- ostensibly special timeworn map\
   [33913] = 0, -- purple crafters' scrip\
   [33914] = 0, -- purple gatherers' scrip\
...
\
local s = \"ffxiv_item{character=\\\"%s\\\",id=\\\"%s\\\"} %d\"\
...
for item_id, item_count in pairs(items_summed) do\
   tbl[#tbl + 1] = string.format(s, Player.name, item_id, item_count)\
end\
\
...
return true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "ed2a3fab-4390-0eb7-9ad1-44a0f9ff6a2e";
	};
	[8] = {
		["actions"] = {
			[1] = {
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "b26cd9d2-3412-3b8b-923b-b01b36b1a784";
	};
	[9] = {
		["actions"] = {
			[1] = {
...
";
		...
		["conditions"] = {
			...
			[4] = {
				...
				["clusterRange"] = 30;
				["comparator"] = 1;
				["conditionLua"] = "-- is running\
return FFXIV_Common_BotRunning == true or (HusbandoMaxAddonStatus ~= nil and\
...
";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "4f26dbb8-bb55-38b0-8f38-4971e6e9f152";
	};
	[10] = {
		["actions"] = {
			[1] = {
   ...
   not Player.alive or Player.incombat\
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "4dc54ba2-36b2-d6ee-85db-9df4457fc86b";
	};
	[11] = {
		["actions"] = {
			[1] = {
...
reaction.eventConditionMismatch = true";
		...
		["conditions"] = {
			[1] = {
				...
				["clusterRange"] = 30;
				["comparator"] = 1;
				["conditionLua"] = "return (HusbandoMaxAddonStatus ~= nil and HusbandoMaxAddonStatus.DungeonMaster.Enabled == true and InInstance())";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
			...
			[2] = {
				...
				["clusterRange"] = 30;
				["comparator"] = 1;
				["conditionLua"] = "return not HasBuffX(Player.id,49,10452)";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "96848392-16fd-cbf1-b01c-00bcd2b85504";
	};
}
return obj1
